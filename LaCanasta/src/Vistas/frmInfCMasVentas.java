 ...
 * @author aleja
 */
public class frmInfCMasVentas extends javax.swing.JFrame implements Runnable{

    /**
     * Creates new form frmInfCMasVentas
     */
    List<Object[]> lista = new ArrayList();
    Venta v = new Venta();
    public frmInfCMasVentas() {
        initComponents();
        mtdCargarLista();
        h1 = new Thread(this);
        h1.start();
    ...
    private void mtdCargarLista(){
        lista = v.mtdObtenerLista2();
        DefaultTableModel dtm = (DefaultTableModel)tblCajeros.getModel();
        dtm.setRowCount(0);
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Cajeros Con Más Ventas");
        ...
        tblCajeros.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nombres", "Apellidos", "Documentos", "No Ventas"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmInfCMasVentas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmInfCMasVentas().setVisible(true);
            }
        });
    }
