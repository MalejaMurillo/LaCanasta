 ...
 * @author aleja
 */
public class frmInfCMasCompras extends javax.swing.JFrame implements Runnable {

    /**
     * Creates new form frmInfCMasCompras
     */
    List<Object[]> lista = new ArrayList();
    Venta v = new Venta();
    public frmInfCMasCompras() {
        initComponents();  
        mtdCargarLista();
        h1 = new Thread(this);
        h1.start();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmInfCMasCompras.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmInfCMasCompras().setVisible(true);
            }
        });
    }
